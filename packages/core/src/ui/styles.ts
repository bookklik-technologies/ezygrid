...
.ezygrid-suite{--ezg-surface:#f7f9fb;--ezg-muted:#64748b;position:relative;display:flex;flex-direction:column;width:100%;height:100%;min-height:220px;overflow:hidden;box-sizing:border-box;border:1px solid var(--ezygrid-gridline,#e2e8f0);border-radius:0px;background:var(--ezygrid-bg,#fff);color:var(--ezygrid-text,#0f172a);font:13px Outfit,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;isolation:isolate}
...
.ezygrid-suite button{cursor:pointer;border:1px solid transparent;border-radius:5px;background:transparent;min-height:30px;padding:5px 9px;white-space:nowrap;display:inline-flex;align-items:center;justify-content:center;gap:5px}
.ezygrid-suite button:hover{background:var(--ezg-surface);border-color:var(--ezygrid-gridline,#e2e8f0)}
.ezygrid-suite button:disabled{opacity:.4;cursor:default}
...
.ezygrid-suite input,.ezygrid-suite select,.ezygrid-suite textarea{min-width:0;border:1px solid var(--ezygrid-gridline,#e2e8f0);border-radius:5px;background:var(--ezygrid-bg,#fff);padding:5px 7px;min-height:29px}
...
.ezygrid-suite svg{width:17px;height:17px;flex-shrink:0}
.ezg-topbar{display:flex;align-items:center;gap:8px;padding:8px 12px;border-bottom:1px solid var(--ezygrid-gridline,#e2e8f0);flex-shrink:0;min-height:51px}
.ezg-brand{display:flex;align-items:center;gap:8px;font-size:16px;font-weight:600;margin-inline-end:8px}
.ezg-mark{display:grid;place-items:center;background:linear-gradient(135deg,#00ff99,#2563eb);color:#073b35;width:29px;height:29px;border-radius:7px}
...
.ezg-tabs button{border-radius:5px 5px 0 0;padding:6px 13px}
...
.ezg-dialog{border:1px solid var(--ezygrid-gridline,#e2e8f0);border-radius:12px;background:var(--ezygrid-bg,#fff);color:inherit;padding:22px;width:min(440px,90%);max-height:85%;overflow:auto;box-shadow:0 20px 70px #0004;font:inherit}
...
.ezg-message{position:absolute;bottom:43px;inset-inline-start:12px;z-index:1100;max-width:calc(100% - 24px);padding:10px 14px;border:1px solid var(--ezygrid-gridline,#e2e8f0);border-radius:8px;background:var(--ezygrid-bg,#fff);box-shadow:0 4px 20px #0002;font-size:12px;display:flex;gap:12px;align-items:center}
...
.ezygrid-suite .ezygrid-contextmenu{border-radius:7px;padding:4px;min-width:180px!important;font:inherit}.ezygrid-contextmenu-item:hover{background:var(--ezygrid-selection-soft,#e6fff4)}
